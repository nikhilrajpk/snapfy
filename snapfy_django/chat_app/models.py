...
class Message(models.Model):
    ...
    media = models.FileField(upload_to="chat_media/", blank=True, null=True)  # Images, videos, documents
    voice_note = models.FileField(upload_to="chat_voice_notes/", blank=True, null=True)  # Voice messages
    gif_url = models.URLField(blank=True, null=True)  # URL for GIFs (e.g., from Giphy or Tenor)
