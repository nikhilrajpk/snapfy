...
const BlockedUsers = () => {
  ...
  const handleUnblockUser = async (userId) => {
    try {
      ...
      // Remove the user from the list since they are no longer blocked
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        ...
        <div className="text-sm text-gray-500">
          Total Blocked Users: {totalUsers}
        </div>
      </div>
                  ...
                  <tr key={user.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <button
                        ...
                        className="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium transition duration-200 bg-green-100 text-green-800 hover:bg-green-200"
                      >
            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-gray-700">
                  ...
                  <span className="font-medium">{totalUsers}</span> blocked users
                </p>
              </div>
              <div>
